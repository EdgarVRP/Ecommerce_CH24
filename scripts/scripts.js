...
navbar.innerHTML = `<nav class="navbar navbar-expand-md bg-white sticky-top border">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="./index.html">
        <img src="assets/img/logo.png" alt="Logo" width="36">
        <p>Cafe Alfonso</p>
      </a>
...
footer.innerHTML = `<footer class="footer border">
<div class="container">
