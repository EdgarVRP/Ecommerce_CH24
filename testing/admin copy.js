...
on(document, "click", ".btnEditarProducto", (e) => {
	...
	document.getElementById("idProducto").value = e.target.parentNode.parentNode.id;
	console.log(e.target.parentNode.parentNode.id);
	document.getElementById("editnombreProducto").value = e.target.parentNode.parentNode.childNodes[0].innerHTML;
	document.getElementById("editregionProducto").value = e.target.parentNode.parentNode.childNodes[2].innerHTML;
	document.getElementById("editcosechaProducto").value = e.target.parentNode.parentNode.childNodes[3].innerHTML;
	document.getElementById("editalturaProducto").value = e.target.parentNode.parentNode.childNodes[4].innerHTML;
	document.getElementById("edithumedadProducto").value = e.target.parentNode.parentNode.childNodes[5].innerHTML;
	document.getElementById("editprocesoProducto").value = e.target.parentNode.parentNode.childNodes[6].innerHTML;
	document.getElementById("editpreparacionProducto").value = e.target.parentNode.parentNode.childNodes[7].innerHTML;
	document.getElementById("editvariedadProducto").value = e.target.parentNode.parentNode.childNodes[8].innerHTML;
	document.getElementById("editnotaProducto").value = e.target.parentNode.parentNode.childNodes[9].innerHTML;
	document.getElementById("editpuntuacionProducto").value = e.target.parentNode.parentNode.childNodes[10].innerHTML;
	document.getElementById("editprecioProducto").value = e.target.parentNode.parentNode.childNodes[11].innerHTML;
	document.getElementById("editinventarioProducto").value = e.target.parentNode.parentNode.childNodes[12].innerHTML;
});
...
on(document, "click", "#btnModificarProducto", (e) => {
	...
	let preparacionProducto = document.getElementById("editpreparacionProducto").value;
	...
	let puntuacionProducto = document.getElementById("editpuntuacionProducto").value;
	let precioProducto = document.getElementById("editprecioProducto").value;
	let inventarioProducto = document.getElementById("editinventarioProducto").value;
	...
	//SERVER_URL + `productos/${id}`
	// Crear URL con query params
	const url = new URL(SERVER_URL + `productos/${id}`);
...
on(document, "click", ".btnEliminarProducto", (e) => {
	...
	//eliminando producto
	fetch(SERVER_URL + `productos/${idProducto}`, {
...
on(document, "click", "#btnCrearProducto", (e) => {
	...
	if (
		...
		let preparacionProducto = document.getElementById("preparacionProducto").value;
